...
CREATE TABLE `app_media` (
  ...
  `show` tinyint(4) DEFAULT '1' COMMENT 'si se permite mostrar',
...
/*!50003 CREATE PROCEDURE `prc_get_version`()
BEGIN
...
/*!50003 CREATE  PROCEDURE `prc_clone_row`(
...
/*!50003 CREATE  PROCEDURE `prc_table`(
    sTableName VARCHAR(25)
